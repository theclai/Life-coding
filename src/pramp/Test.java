...
/**
 1. check right node first and parent and all the way left left
 ...
 */
    ...
    static class BinarySearchTree {
        ...
        public Node findParent(Node parent, Node inputNode) {
            if (parent == null)
                return parent;
            ...
            return findParent(parent.parent, inputNode);
        }
        ...
        Node findInOrderSuccessor(Node inputNode) {
            ...
            if (inputNode.right != null) {
                return findSmallestChild(inputNode.right, inputNode.right.left);
